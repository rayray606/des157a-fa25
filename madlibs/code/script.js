...
const story = `Chiikawa is a(n) ${adj1}, ${adj2} creature. Their friends Hachiware and Usagi go on ${adj3} adventures; ${verb1}, eating ${adj4} food, ${verb2} monsters. Chiikawa tends to feel anxious. Help make a wishlist with them:
